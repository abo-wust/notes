...
3、vxlan实现
  ...
  1. PC1访问PC2（例如：ping 1.1.2.2），判断目标主机是否同网段，是
1. PC1发出针对PC2的ARP请求，交换机LSW1的GE0/0/1口收到ARP报文后打上vlan 10的tag，然后经二层转发从GE0/0/2口发出带vlan 10的ARP请求报文
2. 交换机CE1的GE1/0/0口收到带vlan 10的报文，根据vlan到BD的映射配置，将vlan 10的报文映射到BD 5
3. CE1根据vxlan的隧道配置，通过VTEP1将报文送到CE2上的VTEP2
4. CE2的VTEP2收到报文后，根据BD到vlan的映射，将BD 5的报文映射到vlan 20，经二层转发从CE2的GE1/0/0口发出
5. LSW2的GE0/0/2口收到vlan 20的ARP请求报文，二层转发到PC2，PC2响应该ARP请求报文，实现两台不同vlan的通信。
